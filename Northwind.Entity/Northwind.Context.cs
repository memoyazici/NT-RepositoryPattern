...
namespace Northwind.Entity
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual int sp_createNewTable(string tablename, string iD, string col1Type, string column2, string col2Type, string column3, string col3Type)
        {
            ...
            var col1TypeParameter = col1Type != null ?
                new ObjectParameter("Col1Type", col1Type) :
                new ObjectParameter("Col1Type", typeof(string));
    
            var column2Parameter = column2 != null ?
                new ObjectParameter("Column2", column2) :
                new ObjectParameter("Column2", typeof(string));
    
            var col2TypeParameter = col2Type != null ?
                new ObjectParameter("Col2Type", col2Type) :
                new ObjectParameter("Col2Type", typeof(string));
    
            var column3Parameter = column3 != null ?
                new ObjectParameter("Column3", column3) :
                new ObjectParameter("Column3", typeof(string));
    
            var col3TypeParameter = col3Type != null ?
                new ObjectParameter("Col3Type", col3Type) :
                new ObjectParameter("Col3Type", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_createNewTable", tablenameParameter, iDParameter, col1TypeParameter, column2Parameter, col2TypeParameter, column3Parameter, col3TypeParameter);
        }
    
        public virtual int sp_funcOrProc(Nullable<int> iD, ObjectParameter quan)
        {
            var iDParameter = iD.HasValue ?
                new ObjectParameter("ID", iD) :
                new ObjectParameter("ID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_funcOrProc", iDParameter, quan);
        }
    
        public virtual int sp_orders_backup_byYears(Nullable<int> startingYear, Nullable<int> endingYear)
        {
            var startingYearParameter = startingYear.HasValue ?
                new ObjectParameter("startingYear", startingYear) :
                new ObjectParameter("startingYear", typeof(int));
    
            var endingYearParameter = endingYear.HasValue ?
                new ObjectParameter("endingYear", endingYear) :
                new ObjectParameter("endingYear", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_orders_backup_byYears", startingYearParameter, endingYearParameter);
        }
